...
export const Navbar = () => {
    ...
    return (
        <div className='w-full flex items-start justify-between fixed top-0 left-0 z-10 '>
            
            <div className='w-[13vw] p-4 relative z-50'>
            ...
            <div onClick={() => setIsOpen(true)} className='w-[16vw] h-14 flex items-center justify-end relative overflow-hidden hover:cursor-pointer group'>
